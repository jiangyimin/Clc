...
{
    public abstract class ClcCrudController<TEntity, TEntityDto> : ClcCrudController<TEntity, int, TEntityDto>
    ...
    public abstract class ClcCrudController<TEntity, TPrimaryKey, TEntityDto> : ClcCrudControllerBase<TEntity, TPrimaryKey, TEntityDto>
        where TEntity : class, IEntity<TPrimaryKey>
        where TEntityDto : IEntityDto<TPrimaryKey>
    {
        protected ClcCrudController(IRepository<TEntity, TPrimaryKey> repository)
            : base(repository)
        {
        }
