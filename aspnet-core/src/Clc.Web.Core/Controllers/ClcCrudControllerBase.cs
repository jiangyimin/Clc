...
{
    public abstract class ClcCrudControllerBase<TEntity, TEntityDto> : ClcCrudControllerBase<TEntity, int, TEntityDto>
        where TEntity : class, IEntity
        where TEntityDto : IEntityDto
    {
        protected ClcCrudControllerBase(IRepository<TEntity> repository)
            : base(repository)
        {
    ...
    public abstract class ClcCrudControllerBase<TEntity, TPrimaryKey, TEntityDto> : ClcControllerBase
        ...
        where TEntityDto : IEntityDto<TPrimaryKey>
    {
        ...
        protected ClcCrudControllerBase(IRepository<TEntity, TPrimaryKey> repository)
        {
